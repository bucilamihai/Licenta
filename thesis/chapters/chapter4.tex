...
Sunt oferite detalii despre arhitectură și sunt explicate în detaliu principalele funcționalități.
...
Recomandările se realizează printr-o comunicare între serverului Java și sistemul de recomandare, care este implementat separat, scris în Python, folosind framework-ul Flask \cite{flaskdocs}.
...
\begin{figure}[htbp]
	\centering
    \includegraphics[scale=0.27]{./figures/register-page.png}
...
\begin{figure}[htbp]
	\centering
    \includegraphics[scale=0.33]{./figures/onboarding-page.png}
...
\begin{figure}[htbp]
	\centering
    \includegraphics[scale=0.30]{./figures/logout-component.png}
